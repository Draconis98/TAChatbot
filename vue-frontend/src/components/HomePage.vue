...
function authenticate() {
  axios.get('https://10.30.19.40:8080/auth')
      .then((response) => {
...
onMounted(() => {
      ...
      console.log(userID)
      if (userID != null) {
        axios.get('https://10.30.19.40:8080/get/username?userID=' + userID)
            .then((response) => {
              console.log(response.data);
...
function createNewQuestion() {
  ...
  let userID = window.sessionStorage.getItem('userID');
  console.log(userID)
  axios.get('https://10.30.19.40:8080/new/card?userID=' + userID)
      .then((response) => {
        console.log(response.data);
...
function getCardsSortedByLatest() {
  axios.get('https://10.30.19.40:8080/show/latest')
      .then((response) => {
...
function getCardsSortedByHottest() {
  axios.get('https://10.30.19.40:8080/show/hottest')
      .then((response) => {
        cards.value = response.data.card_list;
        console.log(cards.value);
      })
...
onMounted(() => {
  axios.get('https://10.30.19.40:8080/show/')
      .then((response) => {
        cards.value = response.data.card_list;
        console.log(cards.value);
      })
